...
export const Login = ({onLoginSuccess, onGoToRegister}) => {
    ...
    return(
        ...
        rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            <div className="bg-gradient-to-r from-violet-700 to-purple-800 
                px-6 py-6 text-center text-white">
                <h2 className="text-2xl font-bold">¡Bienvenido de new!</h2>
                <p className="text-violet-200 mt-1 text-sm">Inicia sesion 
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              className="pl-11 w-full p-3 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-violet-500 transition-all text-gray-900"
